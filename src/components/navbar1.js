        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text14">Home</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text18">About Us</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar1-text17">Menu</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar1-text19">Contact</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar1-text20">Order Online</span>
                </Fragment>
              )}
            </a>
          </nav>
          <div className="navbar1-buttons1">
            <button className="navbar1-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar1-text15">Sign Up</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar1-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar1-text16">Log In</span>
                  </Fragment>
                )}
              </span>
            </button>
